          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div className="flex flex-wrap justify-between gap-3 p-4">
              <div className="flex min-w-72 flex-col gap-3">
                <p className="text-[#111518] tracking-light text-[32px] font-bold leading-tight text-left">Contact Us</p>
                <p className="text-[#617689] text-sm font-normal leading-normal text-left">We're here to help! Reach out to us with any questions or feedback.</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-white px-4 min-h-14">
              ...
              <p className="text-[#111518] text-base font-normal leading-normal flex-1 truncate text-left">Phone: (555) 123-4567</p>
            </div>
            ...
            <div className="flex flex-col p-4 gap-3">
              <details className="flex flex-col rounded-xl border border-[#dbe1e6] bg-white px-[15px] py-[7px] group" open>
                <summary className="flex cursor-pointer items-center justify-between gap-6 py-2">
                  <p className="text-[#111518] text-sm font-medium leading-normal text-left">How does SponZilla work?</p>
                ...
                <p className="text-[#617689] text-sm font-normal leading-normal pb-2 text-left">
              ...
              <details className="flex flex-col rounded-xl border border-[#dbe1e6] bg-white px-[15px] py-[7px] group">
                <summary className="flex cursor-pointer items-center justify-between gap-6 py-2">
                  <p className="text-[#111518] text-sm font-medium leading-normal text-left">What types of sponsorships are available?</p>
                  <div className="text-[#111518] group-open:rotate-180" data-icon="CaretDown" data-size="20px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                      <path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>
                    </svg>
              ...
              <details className="flex flex-col rounded-xl border border-[#dbe1e6] bg-white px-[15px] py-[7px] group">
                <summary className="flex cursor-pointer items-center justify-between gap-6 py-2">
                  <p className="text-[#111518] text-sm font-medium leading-normal text-left">How can I get started?</p>
                  <div className="text-[#111518] group-open:rotate-180" data-icon="CaretDown" data-size="20px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                      <path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>
                    </svg>
              ...
              <p className="text-[#111518] text-base text-left font-normal leading-normal pb-3 pt-3 px-4">
              We offer various sponsorship types, including event sponsorships, in-kind donations, and long-term partnerships.
            </p>
            <p className="text-[#111518] text-base text-left font-normal leading-normal pb-3 pt-1 px-4">
              Sign up as a club or brand, create your profile, and start exploring sponsorship opportunities.
            </p>
            </div>
          </div>
        </div>
