...
class EventController {
    ...
    async generatePitchContent(req, res) {
        try {
            ...
            // Import Gemini service
            const { generatePitchContent } = require('../services/geminiService');
            ...
            console.error('Pitch content generation error:', error);
            res.status(500).json({ 
                error: error.message || 'Failed to generate pitch content'
            });
        }
    }
}
